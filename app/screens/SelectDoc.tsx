...
const VerifyIdentity = () => {
  ...
  return (
    ...
    <BackButton to='/screens/VerifyIdentity' />
      ...
      <View className='flex-1 w-full justify-center items-center -mt-16'>
        ...
        <View className='space-y-4 mb-8'>
          <Button label= "Passport" onPress={() => router.push('/screens/DocScan')} className='mt-6 w-64'/>
          <Button label= "Emirates ID" onPress={() => router.push('/screens/KYC')} className='mt-2 w-64'/>
        </View>
      </View>
