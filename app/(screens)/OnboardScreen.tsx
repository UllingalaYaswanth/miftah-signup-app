    ...
    <View className="flex-1 bg-[#E3DCD4] px-6 pt-12 pb-6">
      ...
      <View className="flex-1 items-center justify-center">
        ...
        <View className="w-full space-y-4 mb-8">
          <Button label="Request Membership" onPress={() => router.push('/VerifyIdentity')} className='mb-6'/>
          <Button label="Request an Agent" onPress={() => router.push('/RequestAgent')} className='mb-6'/>
        </View>
      ...
      <Button label="Save and Exit" onPress={() => router.push('/RequestScreen')} />
    </View>
  );
};
