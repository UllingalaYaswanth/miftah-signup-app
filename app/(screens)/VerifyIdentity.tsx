    ...
    <BackButton to='/OnboardScreen' />
      ...
      <View className='flex-1 justify-center items-center px-4'>
        ...
        <View className='w-full space-y-4 mb-8'>
          <Button label= "Take a picture of Valid ID" onPress={() => router.push('/SelectDoc')} className='mt-6'/>
          <Button label= "Take a Selfie" onPress={() => router.push('/SelectDoc')} className='mt-2'/>
        </View>
      </View>
